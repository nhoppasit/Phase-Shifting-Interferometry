...
set(handles.text2,'String',['avg = ' num2str(pe_avg)])
set(handles.text3,'String',['std = ' num2str(pe_std)])
...
set(handles.text7,'String',['N = ' num2str(k1N)])
...
set(handles.text9,'String',['N = ' num2str(k2N)])
